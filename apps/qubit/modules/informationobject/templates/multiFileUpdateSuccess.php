...
<?php slot('content') ?>
  ...
  <?php echo $digitalObjectTitleForm->renderFormTag(url_for(array($resource, 'module' => 'informationobject', 'action' => 'multiFileUpdate', 'ids' => $requestIds)), array('method' => 'post', 'id' => 'bulk-title-update-form')) ?>
